...
<head>
		...
		function save(){
			...
			$.ajax({
				url:"/bsxykq/admin/course/course_save.jhtml",
	...
	<body class="no-skin" style="background-color:white;overflow-x:hidden">
		...
		<table class="input" style="margin-left:47px;">
			...
			<th style="width:80px">
				...
				<td  width="270">
						<div class="search">
						<input class="text" name="clazz" id="clazz" value=""   style="margin-top:20px"/>
						<input type="button" class="searchBtn" value="" onclick="selectClazz_front()" />
						<input type="hidden" name="clazzId" id="clazzId"  value=""/>
				</div>
				</td>
				<th style="width:80px">
				...
				<td  width="270">
				<div class="search">
						<input class="text" name="teacher" id="teacher" value=""   style="margin-top:20px"/>
			...
			<tr>
				...
				<td  width="270">
				<input id="beginDate1" name="beginDate" class="text Wdate" value="" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd'});" type="text"  />
				</td>
        			<th style="width:80px">
					<span class="requiredField">*</span>结束日期:
				</th>
				<td  width="270">
				<input id="endDate1" name="endDate" class="text Wdate" value="" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd', minDate: '#F{$dp.$D(\'beginDate1\')}'});" type="text"  />
				</td>
			</tr>
			<tr>
				<th style="width:80px">
				...
				<td  width="270">
				<input id="beginTime1" name="beginTime" class="text Wdate" value="" onfocus="WdatePicker({dateFmt: 'HH:mm:ss'});" type="text"  />
				</td>
        			<th style="width:80px">
					<span class="requiredField">*</span>结束时间:
				</th>
				<td  width="270">
				<input id="endTime1" name="endTime" class="text Wdate" value="" onfocus="WdatePicker({dateFmt: 'HH:mm:ss', minDate: '#F{$dp.$D(\'beginTime1\')}'});" type="text"  />
				</td>
			</tr>
			<tr>
			<th style="width:80px">
				...
				<td  width="270">
					<input class="text" name="room" id="room"/>
				</td>
			</tr>
		</table>
