...
<head>
		...
		function update(){
			...
			$.ajax({
				url:"/bsxykq/admin/secretary/secretary_update.jhtml",
	...
	<body class="no-skin" style="background-color:white;overflow-x:hidden">
		...
		<table class="input" style="margin-left:47px;">
			<tr>
				...
				<td  width="270">
					<input readonly="readonly" class="text" name="name" id="name" value="${secretary.name}"/>
				</td>
				<th style="width:80px">
					<span class="requiredField">*</span>性别:
				</th>
				<td  width="270">
					<input readonly="readonly" class="text" name="sex" id="sex" value="${secretary.sex}"/>
				</td>
			</tr>
			<tr>
				<th style="width:80px">
				...
				<td  width="270">
					<input readonly="readonly" class="text" name="no" id="no" value="${secretary.no}"/>
				</td>
				<th style="width:80px">
					<span class="requiredField">*</span>学院:
				</th>
				<td  width="270">
				<input disabled="disabled" class="text" value="${secretary.instituteName!''}"/>
				</td>
			</tr>
				<tr>
				<th style="width:80px">
				...
				<td  width="270">
					<input class="text" name="phone" id="phone" value="${secretary.phone}"/>
				</td>
				<th style="width:80px">
					<span class="requiredField">*</span>邮箱:
				</th>
				<td  width="270">
					<input class="text" name="email" id="email" value="${secretary.email}"/>
				</td>
			</tr>
		</table>
