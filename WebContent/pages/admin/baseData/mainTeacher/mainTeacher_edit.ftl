...
<head>
		...
		function update(){
			...
			$.ajax({
				url:"/bsxykq/admin/mainTeacher/mainTeacher_update.jhtml",
	...
	<body class="no-skin" style="background-color:white;overflow-x:hidden">
		...
		<table class="input" style="margin-left:47px;">
			<tr>
				...
				<td  width="270">
					<input  class="text" name="name" readonly="readonly" id="name" value="${mainTeacher.name!}"/>
				</td>
				<th style="width:80px">
					<span class="requiredField">*</span>性别:
				</th>
				<td  width="270">
					<input  class="text" readonly="readonly" value="${mainTeacher.sex}"/>
				</td>
			</tr>
				...
				<td  width="270">
					<input class="text" name="phone" id="phone" value="${mainTeacher.phone!}"/>
				</td>
				<th style="width:80px">
					<span class="requiredField">*</span>邮箱:
				</th>
				<td  width="270">
					<input class="text" name="email" id="email" value="${mainTeacher.email!}"/>
				</td>
			</tr>
			<tr>
				<th style="width:80px">
				...
				<td  width="270">
					<input  class="text" id="no"  name="no" value="${mainTeacher.no!}" readonly="readonly"/>
				</td>
			
		<th  style="width:80px">
		<span class="requiredField">*</span>所属学院：</th>
		<td>
		<input class="text" readonly="readonly" value="${mainTeacher.instituteName}" /> 
		</td>
		</tr>
		</table>
